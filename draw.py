...
''' screen.fill(red, rect=[offset+face_size, offset, 50, 50])
screen.fill(green, rect=[offset+face_size+piece_size, offset, 50, 50])
screen.fill(orange, rect=[offset+face_size+piece_size*2, offset, 50, 50]) '''
...
for j in range(3):
    for i in range(12):
        if i == 1 and j == 1:
            screen.fill(green, rect=[offset+piece_size, offset+face_size+piece_size, 50, 50])
        elif i == 4 and j == 1:
            screen.fill(red, rect=[offset+piece_size*4, offset+face_size+piece_size, 50, 50])
        elif i == 7 and j == 1:
            screen.fill(blue, rect=[offset+piece_size*7, offset+face_size+piece_size, 50, 50])
        elif i == 10 and j == 1:
